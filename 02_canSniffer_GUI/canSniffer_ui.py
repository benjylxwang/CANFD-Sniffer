...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        item.setText(_translate("MainWindow", "RTR/EXT (hex)"))
        item = self.mainMessageTableWidget.horizontalHeaderItem(3)
        item.setText(_translate("MainWindow", "IDE/Type (hex)"))
        item = self.mainMessageTableWidget.horizontalHeaderItem(4)
        item.setText(_translate("MainWindow", "DLC/Length (hex)"))
        ...
        item.setText(_translate("MainWindow", "DLC/Length (i)"))
